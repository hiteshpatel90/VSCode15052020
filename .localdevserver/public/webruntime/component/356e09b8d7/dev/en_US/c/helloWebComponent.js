Webruntime.moduleRegistry.define('c/helloWebComponent', ['lwc', '@salesforce/i18n/locale', 'lightning/configProvider', '@salesforce/i18n/dir', '@salesforce/client/formFactor', '@salesforce/i18n/number.numberFormat', '@salesforce/i18n/number.percentFormat', '@salesforce/i18n/number.currencyFormat', '@salesforce/i18n/currency', '@salesforce/i18n/dateTime.mediumDateFormat', '@salesforce/i18n/dateTime.mediumTimeFormat', '@salesforce/i18n/firstDayOfWeek', '@salesforce/i18n/dateTime.shortDateFormat', '@salesforce/i18n/dateTime.longDateFormat', '@salesforce/i18n/dateTime.shortTimeFormat', '@salesforce/i18n/timeZone'], function (lwc, locale, configProvider, dir, formFactor, numberFormat, percentFormat, currencyFormat, currency, mediumDateFormat, mediumTimeFormat, firstDayOfWeek, shortDateFormat, longDateFormat, shortTimeFormat, userTimeZone) { 'use strict';
    ...
    firstDayOfWeek = firstDayOfWeek && firstDayOfWeek.hasOwnProperty('default') ? firstDayOfWeek['default'] : firstDayOfWeek;
    shortDateFormat = shortDateFormat && shortDateFormat.hasOwnProperty('default') ? shortDateFormat['default'] : shortDateFormat;
    longDateFormat = longDateFormat && longDateFormat.hasOwnProperty('default') ? longDateFormat['default'] : longDateFormat;
    shortTimeFormat = shortTimeFormat && shortTimeFormat.hasOwnProperty('default') ? shortTimeFormat['default'] : shortTimeFormat;
    userTimeZone = userTimeZone && userTimeZone.hasOwnProperty('default') ? userTimeZone['default'] : userTimeZone;
    ...
    * */
    ...
    function tmpl$l($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 4
      }, [api_text("Today is "), api_dynamic($cmp.currentDate)]), api_text(".")]), api_custom_element("lightning-input", _lightningInput, {
        props: {
          "label": "Name",
          "value": $cmp.greeting
        },
    ...
    tmpl$l.stylesheetTokens = {
      hostAttribute: "lwc-helloWebComponent_helloWebComponent-host",
      shadowAttribute: "lwc-helloWebComponent_helloWebComponent"
    };

    class HelloWebComponent extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.greeting = 'test';
    ...
    var helloWebComponent = lwc.registerComponent(HelloWebComponent, {
      tmpl: _tmpl$k
    });
